...
namespace RBAC_model
{
    ...
    SqlConnection con=new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\RBACDB.mdf;Integrated Security=True");
        ...
        {
            string insert = "Insert into [User](name,address,mobileno,email,username,password,status) values ('"+nameTxt.Text+"','"+addressTxt.Text+"','"+mobileTxt.Text+"','"+emailTxt.Text+"','"+usernameTxt.Text
                +"','"+passwordTxt.Text+"','')";
